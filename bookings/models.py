...
class Booking(models.Model):
    ...
    review = models.TextField(max_length=200, null=True, default='--')
    prescription = models.TextField(max_length=200, null=True, default='--')
    status = models.IntegerField(choices=STATUS_CHOICES, default=0)
    prescribed_date = models.DateTimeField(auto_now_add=False, null=True, blank=True)
    pr_no = models.CharField(max_length=40, default='--')
